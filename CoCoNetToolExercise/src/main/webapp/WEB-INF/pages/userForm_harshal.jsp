        ...
        <div class="row">
        	<div class="col-lg-10">
                <div class="well bs-component">
                    <form class="form-horizontal" name="userForm_harshal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="txtFullname" placeholder="Full name" ng-model="user.fullname" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="password" class="form-control" id="txtPassword" placeholder="Password" ng-model="user.password" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="email" class="form-control" id="txtEmail" name="txtEmail" placeholder="Email Address" ng-model="user.email" required="required" ng-pattern='/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/'>
                                </div>
                                <div class="col-lg-10 col-lg-offset-2" data-ng-show="userForm_harshal.txtEmail.$error.pattern">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" id="txtDob" class="form-control" placeholder="yyyy-mm-dd" ng-model="user.dateofbirth" required="required"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-lg-offset-2" data-ng-show="userForm_harshal.txtPhoneNumber.$error.pattern">
                            ...
                            <div class="form-group">
                                <div class="col-lg-10 col-lg-offset-2">
                                    <button type="submit" class="btn btn-primary" ng-if="user.id == undefined" ng-click="ctrl.userSave();" ng-disabled="userForm_harshal.$invalid || hobbies.length==0">Submit</button>
                                    <button type="submit" class="btn btn-primary" ng-if="user.id > 0" ng-click="ctrl.userUpdate();" ng-disabled="userForm_harshal.$invalid || hobbies.length==0">Submit</button>
