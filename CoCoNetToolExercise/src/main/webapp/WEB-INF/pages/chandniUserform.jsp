                    ...
                    <form class="form-horizontal" ng-submit="ctrl.onSave(userForm.$invalid)" name="userForm" enctype="multipart/form-data"  novalidate="novalidate" form-submit-validation="">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="password" required class="form-control" id="txtPassword" placeholder="Password" maxlength="25" ng-model="userChandni.userPassword" required data-ng-init="userChandni.userPassword ='${userChandni.userPassword}'">
